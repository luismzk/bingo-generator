...
const positiveActionTemplates = [
  ...
  "saves a drowning puppy",
  "floats away in a hot air balloon",
  "builds an orphanage",
  "adopts 50 cats",
  "saves a whale",
  "discovers a new planet",
  "wins the lottery and gives it all away",
  "becomes a superhero",
  ...
  "builds a theme park",
  "starts a space program",
  "becomes a wizard",
  "saves the world from aliens",
  "discovers the fountain of youth",
  "becomes immortal",
  "saves all the puppies",
  "builds a castle",
  "starts a peaceful revolution",
  "becomes a saint",
  "saves Christmas",
  "discovers a cure for aging",
  "becomes a time traveler",
  "saves the bees",
  "builds a utopia",
  "rescues a stranded dolphin",
  "founds a new country",
  "invents teleportation",
  "solves world hunger",
  "ends all wars",
  "discovers a new element",
  "becomes a unicorn",
  "saves a baby from a burning building",
  "builds a time machine",
  "discovers the meaning of life",
  "becomes a demigod",
  "saves the entire ocean",
  "builds a city on Mars",
  "discovers parallel universes",
  "becomes best friends with Bigfoot",
  "saves every endangered animal",
  "builds a bridge to the moon",
  "discovers a new galaxy",
  "becomes a guardian angel",
  "saves humanity from extinction",
  "builds a floating city",
  "discovers the secret to happiness",
  "becomes a living legend",
  "saves every tree in the world",
  "builds a monument to peace",
  "discovers the cure for all diseases",
